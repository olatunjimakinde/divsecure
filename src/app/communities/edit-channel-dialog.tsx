    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    <DialogTitle>Edit Message Board</DialogTitle>
                    <DialogDescription>
                        Modify settings for this message board.
                    </DialogDescription>
                </DialogHeader>
                <form action={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="slug" name="slug" defaultValue={channel.slug} required />
                    </div>
                    ...
                    <div className="flex items-center space-x-2">
                        <input
                            ...
                            id="allowReplies"
                            name="allowReplies"
                            defaultChecked={channel.allow_replies}
